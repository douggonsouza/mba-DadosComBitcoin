        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                  <div>
                      <canvas id="primeiroGrafico" style="height: 600px; width: 1088px;"></canvas>
                      <script>
                                        ...
                                        @if(!$isLine)
                                          {
                                            label: '{{$ln['name']}}',
                                            data: [
                                              @php($isPriceUsd = false)
                                              @foreach ($ln['flPriceUsd'] as $priceUsd)
                                                @if(!$isPriceUsd)
                                                  {{$priceUsd}}
                                                  @php($isPriceUsd = true)
                                                @else
                                            ...
                                            borderColor: "{{$ln['backgroundColor']}}"
                                          }
                                          @php($isLine = true)
                                        @else
                                          ,{
                    ...
                    <div class="grid">
                        ...
                        <div class="p-12">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="#" class="underline text-gray-900 dark:text-white">Notificação</a></div>
                            </div>
